...
public class FindFreePortTest {
    ...
    public void givenExplicitOccupiedPort_whenCreatingServerSocket_thenExceptionIsThrown() {
        try (ServerSocket serverSocket = new ServerSocket(FREE_PORT_NUMBER)) {
            try (ServerSocket serverSocket2 = new ServerSocket(FREE_PORT_NUMBER)) {
    ...
    @Test
    public void givenSpringFindAvailableTcpPort_whenCreatingServerSocket_thenThatPortIsAssigned() {

...
public class UseDateTimeFormatterTest {
    ...
    public void givenALocalDate_whenFormattingWithStyleAllAndLocale_thenPass() {
        String result = subject.formatWithStyleAndLocale(localDateTime, FormatStyle.MEDIUM, Locale.CHINA);
        ...
        result = subject.formatWithStyleAndLocale(localDateTime, FormatStyle.SHORT, Locale.CHINA);

...
public class UseLocalDateTimeTest {
    ...
    public void givenString_whenUsingParse_thenLocalDateTime() {
        LocalDateTime givenLocalDateTime = useLocalDateTime.getLocalDateTimeUsingParseMethod("2016-05-10T06:30");
    ...
    public void whenRequestTimeFromEpoch_thenResultIsAsExpected() {
        ...
        result = useLocalDateTime.ofEpochSecond(1465817690, ZoneOffset.of("+8"));

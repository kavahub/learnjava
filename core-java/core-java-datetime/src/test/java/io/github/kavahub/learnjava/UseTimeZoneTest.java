...
public class UseTimeZoneTest {
    ...
    public void givenDateWithoutTimeZone_WhenSetTimeZoneUsingJava7_ThenTimeZoneIsSetSuccessfully() {
        ...
        assertEquals(nowUtc.toInstant().getEpochSecond(), nowAsiaSingapore.toInstant().getEpochSecond());
        assertEquals(asiaSingapore, nowAsiaSingapore.getTimeZone());
    ...
    public void givenDateWithoutTimeZone_WhenSetTimeZoneUsingJava8_ThenTimeZoneIsSetSuccessfully() {
        ...
        assertEquals(nowUtc.getEpochSecond(), nowAsiaSingapore.toEpochSecond());
        assertEquals(asiaSingapore, nowAsiaSingapore.getZone());
    }
    ...
    public void givenDateWithoutTimeZone_WhenSetTimeZoneUsingJodaTime_ThenTimeZoneIsSetSuccessfully() {
        ...
        assertEquals(nowUtc.toInstant().getMillis(), nowAsiaSingapore.toInstant().getMillis());
        assertEquals(asiaSingapore, nowAsiaSingapore.getZone());
    }   
}

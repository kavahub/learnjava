...
/**
 * 
 * {@link FairnessBoundedBlockingQueueV2} 测试
 *
 * @author PinWei Wan
 * @since 1.0.0
 */
public class FairnessBoundedBlockingQueueV2Test extends AbstractTestFairnessBoundedBlockingQueue {

    @Override
    protected Queue<Integer> newInstance(int size) {
        return new FairnessBoundedBlockingQueueV2<Integer>(size);
    }

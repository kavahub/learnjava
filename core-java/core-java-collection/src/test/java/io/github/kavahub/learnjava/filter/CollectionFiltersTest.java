...
public class CollectionFiltersTest {
    ...
    public void givenAnIntegerCollection_whenFilteringEvenValues_thenObtainTheFilteredCollectionForAllCases() {
        ...
        Collection<Integer> filteredWithEclipseCollections = EclipseCollectionFilter.findEvenNumbers(BASE_INTEGER_COLLECTION);
        Collection<Integer> filteredWithEclipseCollectionsUsingIterate = EclipseCollectionFilter.findEvenNumbersUsingIterate(BASE_INTEGER_COLLECTION);

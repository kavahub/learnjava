 ...
 * ContainsExample.apacheCommonsStringUtils      thrpt   10  1968.972 ±  98.254  ops/ms
 * ContainsExample.lowerCaseContains             thrpt   10  2333.078 ± 170.203  ops/ms
 * ContainsExample.matchesRegularExpression      thrpt   10   234.021 ±  14.882  ops/ms
 * ContainsExample.patternCaseInsensitiveRegexp  thrpt   10  4083.595 ± 243.943  ops/ms
 * ContainsExample.regionMatches                 thrpt   10   282.634 ±  21.358  ops/ms 
 * @formatter:on
 */
...
public class ContainsExample {
    ...
    public static void main(String[] args) throws Exception {
        Options opts = new OptionsBuilder().include(ContainsExample.class.getSimpleName()).build();

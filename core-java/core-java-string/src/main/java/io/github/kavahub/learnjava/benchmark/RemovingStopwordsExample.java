 ...
 * RemovingStopwordsPerformanceExample.removeAll       avgt   10   5.787 ± 0.276  ms/op
 * RemovingStopwordsPerformanceExample.removeManually  avgt   10   8.134 ± 0.367  ms/op
 * RemovingStopwordsPerformanceExample.replaceRegex    avgt   10  27.810 ± 0.453  ms/op
 * @formatter:on
 */
...
@Warmup(iterations = 1)
@Fork(1)
public class RemovingStopwordsExample {
    private String data;
    ...
    public static void main(String[] args) throws Exception {
        Options opts = new OptionsBuilder().include(RemovingStopwordsExample.class.getSimpleName())
                .build();

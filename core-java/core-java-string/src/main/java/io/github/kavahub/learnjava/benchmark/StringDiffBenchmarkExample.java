 ...
 * StringDiffBenchmarkPerformanceExample.diffMatchPatch  thrpt   10  0.009 ±  0.001  ops/ms
 * StringDiffBenchmarkPerformanceExample.stringUtils     thrpt   10  4.323 ±  0.083  ops/ms
 * @formatter:on
 */
...
@Warmup(iterations = 1)
@Fork(1)
public class StringDiffBenchmarkExample {
    private DiffMatchPatch diffMatchPatch = new DiffMatchPatch();

    private List<String> inputs = randomizeInputs(10000);

    public static void main(String[] args) throws RunnerException {
        Options opts = new OptionsBuilder().include(StringDiffBenchmarkExample.class.getSimpleName())
            .build();

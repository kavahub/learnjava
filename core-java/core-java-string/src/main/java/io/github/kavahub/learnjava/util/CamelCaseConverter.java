...
public class CamelCaseConverter {
    public String toCamelCaseByIteration(String text, char delimiter) {
    ...
    public String toCamelCaseBySplitting(String text, String delimiter) {
        if (text == null || text.isEmpty()) {
            return text;
        }
    ...
    public String toCamelCaseBySplittingUsingStreams(String text, String delimiter) {
        if (text == null || text.isEmpty()) {
            return text;
        }
        String[] words = text.split(delimiter);
    ...
    public String toCamelCaseByRegex(String text) {
        StringBuilder builder = new StringBuilder();
    ...
    public String toCamelCaseUsingICU4J(String text, String delimiter) {
        if (text == null || text.isEmpty()) {
            return text;
        }
    ...
    public String toCamelCaseUsingGuava(String text, String delimiter) {
    ...
    public String toCamelCaseUsingApacheCommons(String text, char delimiter) {

 ...
 * LTrimRTrimBenchmark.apacheCommonsStringUtils     thrpt   10  10482.755 ±  88.442  ops/ms
 * LTrimRTrimBenchmark.guavaCharMatcher             thrpt   10   9661.441 ± 863.516  ops/ms
 * LTrimRTrimBenchmark.patternMatchesLTtrimRTrim    thrpt   10   1514.144 ±  12.534  ops/ms
...
@Warmup(iterations = 1)
@Fork(1)
public class LTrimRTrimBenchmark {
    private String src;
    ...
    public static void main(String[] args) throws Exception {
        Options opts = new OptionsBuilder().include(LTrimRTrimBenchmark.class.getSimpleName())
                .build();

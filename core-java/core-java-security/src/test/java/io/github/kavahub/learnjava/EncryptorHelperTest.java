...
public class EncryptorHelperTest {
    ...
    public void givenEncryptionKey_whenMessageIsPassedToEncryptor_thenMessageIsEncrypted() throws Exception {
        byte[] encryptedMessage = EncryptorHelper.encryptMessage(message.getBytes(),encKeyString.getBytes());
    ...
    public void givenCertificateWithPublicKey_whenMessageIsPassedToEncryptor_thenMessageIsEncrypted() throws Exception {
        ...
        byte[] encryptedMessage = EncryptorHelper.encryptMessage(message.getBytes(),certificate);
    ...
    public void givenEncryptionKey_whenMessageIsEncrypted_thenDecryptMessage() throws Exception{
        byte[] encryptedMessageBytes = EncryptorHelper.encryptMessage(message.getBytes(),encKeyString.getBytes());

        byte[] clearMessageBytes = EncryptorHelper.decryptMessage(encryptedMessageBytes, encKeyString.getBytes());

package io.github.kavahub.learnjava.kafka.streamsvsconsumer;
...
/**
 * test needs a Docker instance running so that kafka container can be created
 *  
 * @author PinWei Wan
 * @since 1.0.2
 */
public class KafkaStreamsIntegerationTest {

package io.github.kavahub.learnjava.kafka.admin;
...
/**
 * 
 * test needs a running Docker instance so that a kafka container can be created 
 *  
 * @author PinWei Wan
 * @since 1.0.2
 */
@Testcontainers
public class KafkaTopicApplicationIntegrationTest {

...
public class TableTest {
    ...
    @Test
    public void givenTable_whenRiwMap_returnsSuccessfully() {
        final Table<String, String, Integer> universityCourseSeatTable = HashBasedTable.create();
        universityCourseSeatTable.put("Mumbai", "Chemical", 120);
        universityCourseSeatTable.put("Mumbai", "IT", 60);
        universityCourseSeatTable.put("Harvard", "Electrical", 60);
        ...
        final Map<String, Map<String, Integer>> courseKeyUniversitySeatMap = universityCourseSeatTable.rowMap();

        assertThat(courseKeyUniversitySeatMap).hasSize(2);
        assertThat(courseKeyUniversitySeatMap.get("Mumbai")).hasSize(2);
        assertThat(courseKeyUniversitySeatMap.get("Mumbai").get("IT")).isEqualTo(60);
        assertThat(courseKeyUniversitySeatMap.get("Harvard")).hasSize(2);
    }

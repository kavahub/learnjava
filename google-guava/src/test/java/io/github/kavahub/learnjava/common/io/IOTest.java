...
public class IOTest {
    ...
    public void whenWriteUsingCharSink_thenWritten() throws IOException {
        ...
        final File file = new File("test.out");
    ...
    public void whenCopyFileUsingFiles_thenCopied() throws IOException {
        ...
        final File file1 = new File("src/test/resources/test1.in");
        final File file2 = new File("test_copy.in");
    ...
    public void whenWriteReadLittleEndian_thenCorrect() throws IOException {
        ...
        final LittleEndianDataOutputStream writer = new LittleEndianDataOutputStream(new FileOutputStream("test_le.txt"));
        writer.writeInt(value);
        writer.close();

        final LittleEndianDataInputStream reader = new LittleEndianDataInputStream(new DataInputStream(new FileInputStream("test_le.txt")));
